...
export const createProduct = (name, price, image, brand, description, countInStock, category) => async (dispatch, getState) => {
    ...
    try {
        ...
        const { data } = await axios.post(`/api/products`, form, config)
